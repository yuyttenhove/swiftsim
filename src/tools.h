...
void pairs_all_boundary(struct runner *r, struct cell *ci, struct cell *cj); /* boundary_loop */
void self_all_boundary(struct runner *r, struct cell *ci); /* boundary_loop */
