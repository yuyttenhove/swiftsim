...
__attribute__((always_inline)) INLINE static void hydro_debug_particle(
  ...
  printf(
      ...
      p->fluid_v[0], p->fluid_v[1], p->fluid_v[2],
      p->rho, p->P, p->gradients.rho[0],
      p->gradients.rho[1], p->gradients.rho[2],
      p->gradients.v[0][0], p->gradients.v[0][1],
      p->gradients.v[0][2], p->gradients.v[1][0],
      p->gradients.v[1][1], p->gradients.v[1][2],
      p->gradients.v[2][0], p->gradients.v[2][1],
      p->gradients.v[2][2], p->gradients.P[0],
      p->gradients.P[1], p->gradients.P[2],
#if defined(SHADOWFAX_SLOPE_LIMITER_CELL) || defined(SHADOWFAX_SLOPE_LIMITER_CELL_EXACT)
      p->limiter.rho[0], p->limiter.rho[1],
      p->limiter.v[0][0], p->limiter.v[0][1],
      p->limiter.v[1][0], p->limiter.v[1][1],
      p->limiter.v[2][0], p->limiter.v[2][1],
      p->limiter.P[0], p->limiter.P[1],
